...
class Individual {
	...
	List<Double> gen;
	List<Double> fitnessTask; // giá trị thích nghi của các Task
	List<Integer> factorial_rank;

	private int skillFactor; // giá trị thích nghi
	...
	public String toString() {
		return "Individual [gen=" + gen + ", fitnessTask=" + fitnessTask + ", factorialRank=" + factorial_rank
				+ ", skillFactor=" + skillFactor + ", scalarFitness=" + scalarFitness + "]";
	}
